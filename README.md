...
- ### Footer
     ...
     - When hovered, the icon logos change from gold to white and slightly increases in size
     - Transition command is used for a cleaner change when hovering
...
- ## The Sign Up Form
     - The sign up form includes the main colours of the site
     ...
     - For the current purose of not having a page to post the data to, I did not inclide the "method" or "url" in the form element
...
- HTML
  -No issues were found when passing the site through the W3 validator
...
4. Open up Git Bash
5. in the Bash area type 'git clone' then paste in the given link
...
- My mentor gave great advice and feedback for the progression on building the site